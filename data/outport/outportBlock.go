//go:generate protoc -I=. -I=$GOPATH/src/github.com/subrahamanyam341/andes-abc-01/data/block -I=$GOPATH/src -I=$GOPATH/src/github.com/dharitri/protobuf/protobuf --gogoslick_out=$GOPATH/src outportBlock.proto

package outport

import (
	"github.com/subrahamanyam341/andes-abc-01/data"
	"github.com/subrahamanyam341/andes-abc-01/data/block"
)
