...
import (
	...
	alteredAccount "github.com/subrahamanyam341/andes-abc-01/data/alteredAccount"
	block "github.com/subrahamanyam341/andes-abc-01/data/block"
	receipt "github.com/subrahamanyam341/andes-abc-01/data/receipt"
	rewardTx "github.com/subrahamanyam341/andes-abc-01/data/rewardTx"
	smartContractResult "github.com/subrahamanyam341/andes-abc-01/data/smartContractResult"
	transaction "github.com/subrahamanyam341/andes-abc-01/data/transaction"
	io "io"
	math "math"
	math_big "math/big"
	math_bits "math/bits"
...
type FeeInfo struct {
	...
	Fee            *math_big.Int `protobuf:"bytes,2,opt,name=Fee,proto3,casttypewith=math/big.Int;github.com/subrahamanyam341/andes-abc-01/data.BigIntCaster" json:"fee,omitempty"`
	InitialPaidFee *math_big.Int `protobuf:"bytes,3,opt,name=InitialPaidFee,proto3,casttypewith=math/big.Int;github.com/subrahamanyam341/andes-abc-01/data.BigIntCaster" json:"initialPaidFee,omitempty"`
}
...
var fileDescriptor_661b95cef868af95 = []byte{
	...
	,
}
